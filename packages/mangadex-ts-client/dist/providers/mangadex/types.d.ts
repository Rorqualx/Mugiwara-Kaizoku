...
export type MangaDexRelationshipType = 'manga' | 'chapter' | 'cover_art' | 'author' | 'artist' | 'scanlation_group' | 'tag' | 'user' | 'custom_list' | 'creator';
...
export type SafeParams = Record<string, string | number | boolean | (string | number)[] | Record<string, string> | undefined>;
export declare function isMangaDexErrorResponse(response: unknown): response is MangaDexErrorResponse;
export declare function isMangaDexSuccessResponse<T>(response: unknown): response is MangaDexApiResponse<T>;
