// @file-size-justified: central phase-finalize orchestrator — each submodule
// already extracted; ~20 sequential post-enrichment steps compose here and
// splitting further would obscure the ordering contract.
/**
 * Phase 4: Finalize
 *
