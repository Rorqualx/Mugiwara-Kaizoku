...
```typescript
import { logMangaAdded, logDownloadStarted } from '@/utils/system-events';
...
The `utils/system-events/` directory provides many helper functions for common events:
...
1. Add a new helper function to a module under `utils/system-events/`
